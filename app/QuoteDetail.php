...
class QuoteDetail extends Model
{
    protected $fillable = [ 
        ...
        'booking_reference','booking_type','supplier_currency_id','comments','estimated_cost','markup_amount','markup_percentage','selling_price','profit_percentage','estimated_cost_bc','selling_price_bc',
        'package_key','markup_amount_bc','added_in_sage', 'time_of_service', 'amount_per_person', 'booking_type_id', 'parent_id'
    ];
