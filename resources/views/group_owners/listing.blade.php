...
@section('title','View Group Owners')
...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-6">
          <div class="d-flex">
            <h4>View Group Owners <x-add-new-button :route="route('group_owners.create')" /> </h4>
          </div>
        </div>
        <div class="col-sm-6">
  ...
  <x-page-filters :route="route('group_owners.index')">
    <div class="row">
      <div class="col-md-12">
          ...
          <div class="card">
                ...
                <form method="POST" id="group_owner_bulk_action" action="{{ route('group_owners.bulk.action') }}" >
                  ...
                  <div class="dropdown show btn-group">
                    ...
                    <div class="dropdown-menu">
                      <button type="button" data-action_type="delete" class="dropdown-item group-owner-bulk-action-item"><i class="fa fa-trash text-red mr-2"></i>Delete</button>
                    </div>
                  </div>
                </form>
              </div>
            ...
            <div class="card-body p-0" id="listing_card_body">
              <div class="table-responsive">
                ...
                <tbody>
                  @if($group_owners && $group_owners->count())
                    @foreach ($group_owners as $value)
                      <tr>
                        ...
                        <td class="d-flex justify-content-center ml-2">
                          <a href="{{ route('group_owners.edit', encrypt($value->id)) }}" class=" mr-2 btn btn-outline-success btn-xs" title="Edit"><i class="fa fa-fw fa-edit"></i></a>
                          <form method="post" action="{{ route('group_owners.destroy', encrypt($value->id))}}" class="delete-group-owner">
                            @csrf
                            @method('delete')
