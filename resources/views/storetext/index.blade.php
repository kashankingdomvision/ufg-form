            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-header">
                            <div class="row">
                            <form method="POST" id="store_text_bulk_action" action="{{ route('store_texts.bulk.action') }}" >
                                @csrf
                                ...
                                <div class="dropdown show btn-group">
                                    ...
                                    <div class="dropdown-menu">
                                        <button type="button" data-action_type="delete" class="dropdown-item store-text-bulk-action-item"><i class="fa fa-trash text-red mr-2"></i>Delete</button>
                                    </div>
                                </div>
                            </form>
                            </div>
