                  ...
                  <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input type="text" value="{{ $quote['ref_no']}}" name="ref_no" class="form-control" placeholder="Enter Reference Number">
                      </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input type="text" value="{{ $quote['quote_no'] }}" name="quote_no" class="form-control" placeholder="Quote Reference Number" >
                      </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input type="text" value="{{ $quote['lead_passenger'] }}" name="lead_passenger" class="form-control" placeholder="Lead Passenger Name" >
                      </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <select name="brand_id" id="brand_id" class="form-control getBrandtoHoliday  brand-id @error('brand_id') is-invalid @enderror">
                          ...
                          @foreach ($quote as $brand)
                            <option value="{{ $brand->id }}" {{ ($quote['brand_id'] == $brand->id)? 'selected':NULL }}> {{ $brand->name }} </option>
                          @endforeach
                        </select>
                      ...
                      <div class="form-group">
                        ...
                        <div>
                          <label class="radio-inline">
                            <input class="select-agency" {{ $quote['agency'] ==  1 ? 'checked' : '' }}  value="yes" type="radio" name="agency" > Yes
                          </label>
                          <label class="radio-inline">
                            <input  class="select-agency" {{ $quote['agency'] ==  0? 'checked' : '' }}  value="no" type="radio" name="agency" > No
                          </label>
                        </div>
                      </div>
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input type="text" value="{{ $quote['dinning_preferences'] }}" name="dinning_preferences" class="form-control" placeholder="Dinning Preferences" >
                      </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input type="text" value="{{ $quote['dinning_preferences'] }}" name="bedding_preference" class="form-control" placeholder="Bedding Preferences" >
                      </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <select name="pax_no" id="pax_no" class="form-control paxNumber pax-number">
                          <option value="$quote['pax_no']">{{ $quote['pax_no'] }}</option>
                                ...
                                <div class="mb-2 appendCount" id="appendCount{{ $count }}">
                                    <div class="row" >
                                        ...
                                        <div class="col-md-4 mb-2">
                                            ...
                                            <input type="number" name="pax[{{$count}}][contact_number]" value="{{ $pax['contact_number'] }}" class="form-control" placeholder="CONTACT NUMBER" >
                                            <div class="alert-danger errorpax" style="text-align:center" id="error_pax_name_'+validatecount+'"></div>
                                        </div>
                                    </div>
                                    <div class="row">
                            ...
                            <div class="row"> {{-- ?>>>rowStart --}}
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="quote[{{ $key }}][supervisor_id]" data-name="supervisor_id" id="quote_{{ $key }}_supervisor_id" class="form-control  select2  supervisor-id @error('supervisor_id') is-invalid @enderror">
                                        <option value="">{{ $quote['supervisor_id'] }}</option>
                                    </select>
