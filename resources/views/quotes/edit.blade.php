                      ...
                      <div class="form-group">
                        ...
                        <div>
                          <label class="radio-inline">
                            <input class="select-agency" {{ old('agency') == 'yes' ? "checked" : ($quote->agency ==  1 ? 'checked' : '') }}  value="yes" type="radio" name="agency" > Yes
                          </label>
                          <label class="radio-inline">
                            <input  class="select-agency" {{ old('agency') == 'no'  ? "checked" : ($quote->agency ==  0? 'checked' : '') }}  value="no" type="radio" name="agency" > No
                          </label>
                        </div>
                      </div>
                        ...
                        <div class="quote" data-key="0">
                            ...
                            <div class="row"> {{-- ?>>>rowStart --}}
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ $q_detail->booking_due_date }}" name="quote[{{ $key }}][booking_due_date]" autocomplete="off" data-name="booking_due_date" id="quote_{{ $key }}_booking_due_date" class="form-control booking-due-date datepicker checkDates bookingDueDate" placeholder="Booking Due Date">
                                </div>
                                </div>
