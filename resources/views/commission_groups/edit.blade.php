...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row">
          <div class="col-sm-6"><h4>Edit Commission Group</h4></div>
          <div class="col-sm-6">
            ...
            <form method="POST" id="store_commission_group" action="{{ route('commission_groups.update', encrypt($commission_group->id)) }}">
              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="text" name="name" id="name" value="{{ $commission_group->name }}" class="form-control @error('name') is-invalid @enderror" placeholder="Group Name" >
              ...
              <div class="card-footer">
                ...
                <a href="{{ route('commission_groups.index') }}" class="btn btn-danger float-right  mr-2">Cancel</a>
              </div>
            </form>
