                            ...
                            <form method="POST" id="season_bulk_action" action="{{ route('seasons.bulk.action') }}" >
                                ...
                                <div class="dropdown show btn-group">
                                    ...
                                    <div class="dropdown-menu">
                                        <button type="button" data-action_type="delete" class="dropdown-item season-bulk-action-item"><i class="fa fa-trash text-red mr-2"></i>Delete</button>
                                    </div>
                                </div>
                            </form>
                            </div>
                                        ...
                                        @foreach ($seasons as $key => $value)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <form method="post" action="{{ route('seasons.destroy', encrypt($value->id)) }}" class="delete-season">
                                                    @csrf
                                                    @method('delete')
