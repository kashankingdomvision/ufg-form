        ...
        <div class="row">
          <div class="offset-md-2 col-md-8">
            ...
            <div class="card card-outline card-base">
              ...
              <form action="{{ route('setting.towns.update', encrypt($town->id)) }}" method="POST">
                @csrf @method('put')
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="name" value="{{ !empty(old('name')) ? old('name') : $town->name }}" class="form-control @error('name') is-invalid @enderror" placeholder="Town Name" >
