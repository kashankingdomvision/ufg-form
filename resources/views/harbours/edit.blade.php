...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-6">
            <h4>Edit Harbours, Train and Points of Interest</h4>
          </div>
          <div class="col-sm-6">
      ...
      <div class="row">
        <div class="offset-md-2 col-md-8">
          ...
          <div class="card card-secondary">
            ...
            <form method="POST" action="{{ route('setting.harbours.update',  encrypt($harbour->id)) }}">
              @csrf
              @method('put')
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="port_id" value="{{ $harbour->port_id }}" class="form-control @error('port_id') is-invalid @enderror" placeholder="Port ID" >
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="name" value="{{ $harbour->name }}" class="form-control @error('name') is-invalid @enderror" placeholder="Harbours, Train and Points of Interest  Name" >
