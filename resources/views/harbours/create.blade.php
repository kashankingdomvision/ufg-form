...
<div class="content-wrapper">
  <section class="content-header">
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-6"><h4>Add Harbours, Train and Points of Interest</h4></div>
        <div class="col-sm-6">
      ...
      <div class="row d-flex justify-content-center">
        <div class="col-md-10">
          <div class="card card-outline card-base">
            ...
            <form method="POST" id="store_harbour" action="{{ route('harbours.store') }}">
              @csrf
              ...
              <div class="card-footer">
                ...
                <a href="{{ route('harbours.index') }}" class="btn btn-danger float-right  mr-2">Cancel</a>
              </div>
            </form>
