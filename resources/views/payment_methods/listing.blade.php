                ...
                <form method="POST" id="payment_method_bulk_action" action="{{ route('payment_methods.bulk.action') }}" >
                  ...
                  <div class="dropdown show btn-group">
                    ...
                    <div class="dropdown-menu">
                      <button type="button" data-action_type="delete" class="dropdown-item payment-method-bulk-action-item"><i class="fa fa-trash text-red mr-2"></i>Delete</button>
                    </div>
                  </div>
                </form>
              </div>
                  ...
                  @if($payment_mehtods && $payment_mehtods->count())
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <form method="post" action="{{ route('payment_methods.destroy', encrypt($value->id)) }}" class="delete-payment-method">
                          @csrf
                          @method('delete')
