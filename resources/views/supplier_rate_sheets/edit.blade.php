      ...
      <div class="row d-flex justify-content-center">
        <div class="col-md-10">
          ...
          <div class="card card-secondary shadow-sm">
            ...
            <form method="POST" id="update_supplier_rate_sheet" action="{{ route('supplier_rate_sheets.update', encrypt($supplier_rate_sheet->id) ) }}" accept-charset="UTF-8" enctype="multipart/form-data"> 
              @csrf @method('put')
              ...
              <div class="card-footer">
                ...
                <a href="{{ route('supplier_rate_sheets.index') }}" class="btn btn-outline-danger float-right mr-2">Cancel</a>
              </div>
            </form>
