        ...
        <div class="row">
          <div class="col-sm-6">
            <h1 class="m-0">Dashboard
              <a href="{{ route('refresh_token') }}" class="btn btn-outline-dark btn-sm d-none"> Refresh Token</a>
            </h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
        ...
        <div class="row">
          <div class="col-lg-4 col-6">
            ...
            <div class="small-box bg-info">
              ...
              <a href="{{ route('bookings.index') }}" class="small-box-footer">View Bookings <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-4 col-6">
