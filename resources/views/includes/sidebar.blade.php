    ...
    <div class="sidebar">
        ...
        <nav>
            <ul class="nav nav-pills nav-sidebar flex-column mt-1" data-widget="treeview" role="menu"
                ...
                <li class="nav-item {{ $route == 'reports.user.report' || $route == 'reports.activity.by.user' || $route == 'reports.supplier.report' || $route == 'reports.customer.report' || $route == 'reports.wallet.report' ? 'menu-open': '' }}">
                    <a href="#" class="nav-link">
