@extends('layouts.app')
@section('title','View Customer Booking')
@section('content')
<div class="content-wrapper">
    ...
    <section class="content">
        <form method="get" action="{{ route('customers.booking.listing', encrypt($customer->lead_passenger_email)) }}">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                                ...
                                <div class="row mt-1">
                                    <div class="col-md-12">
                                        <div class="d-flex justify-content-end">
                                            ...
                                            <a href="{{ route('customers.booking.listing', encrypt($customer->lead_passenger_email)) }}" class="btn btn-outline-dark">Reset<span class="fa fa-repeats"></span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Customer Booking List</h3>
                        </div>
                        <div class="card-body p-0">
                            <div class="table-responsive">
                                <table class="table table-striped table-hover">
