        ...
        <div class="row">
          <div class="offset-md-2 col-md-8">
            ...
            <div class="card card-primary">
              ...
              <form method="POST" action="{{ route('setting.holidaytypes.store') }}" >
                @csrf
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" class="form-control @error('name') is-invalid @enderror" placeholder="Holiday Type Name" required>
