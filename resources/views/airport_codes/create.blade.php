        ...
        <div class="row">
          <div class="offset-md-2 col-md-8">
            ...
            <div class="card card-secondary">
              ...
              <form method="POST" action="{{ route('setting.airport_codes.store') }}">
                @csrf

                <div class="card-body">
                    <div class="form-group">
                      <label>Airport Name <span style="color:red">*</span></label>
                      <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" placeholder="Airport Name" >
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="iata_code" class="form-control @error('iata_code') is-invalid @enderror" placeholder="IATA Code" >
