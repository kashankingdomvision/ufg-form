                                ...
                                @php $count =  $fkey + 1; @endphp
                                  <div class="row finance-clonning row-cols-lg-7 g-0 g-lg-2">
                                    ...
                                    <div class="col-2">
                                      <div class="form-group">
                                        <label>Payment</label>
                                        <select class="form-control" name="quote[{{ $key }}][finance][{{ $fkey }}][payment_method]" data-name="payment_method"  class="form-control select2single payment-method" >
                              ...
                              @else
                                ...
                                <div class="row finance-clonning row-cols-lg-7 g-0 g-lg-2">
                                  ...
                                  <div class="col-2">
                                    <div class="form-group">
                                      <label>Payment</label>
                                      <select class="form-control" name="quote[{{ $key }}][finance][0][payment_method]" data-name="payment_method" id="quote_{{ $key }}_payment_method" class="form-control select2single payment-method" >
                                        <option value="">Select Payment Method</option>
                                        @foreach ($payment_methods as $payment_method)
