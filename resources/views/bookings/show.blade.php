                  ...
                  <div class="card-body">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-6">
                        ...
                        <div class="form-group">
                          <label class="radio-inline mr-1">
                              <input type="radio" name="rate_type" data-status="booking" class="rate-type" value="live"
                              {{ ($booking->rate_type == 'live') ? 'checked': '' }}
                          ...
                          <div class="quote card card-default quote-{{$key}}" data-key="0">
                            ...
                            <div class="card-body">
                              <div class="row">
                                ...
                                <div class="col-sm-2 show-tf {{ isset($booking_detail->getCategory->show_tf) && ($booking_detail->getCategory->show_tf == 0) ? 'd-none' : '' }}">
                                  <div class="form-group">
