...
<div class="content-wrapper">
  <section class="content-header">
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-6"><h4>View Booking</h4></div>
        <div class="col-sm-6">
          ...
          <div class="card card-outline card-base">
            ...
            <div class="tab-content">
              <div class="tab-pane active" id="tab_1">
                <form method="POST" id="show_booking" action="{{ route('bookings.update', encrypt($booking->id)) }}" data-page_status="{{ $status }}" enctype="multipart/form-data"> 
                  <div class="card-body">
                    @csrf @method('put')
                        ...
                        <div class="form-group">
                          ...
                          <select name="country_destination_ids[]" id="country_destination_ids" class="form-control select2-multiple country-destination" data-placeholder="Select Destination Country" multiple>
                            @foreach ($supplier_countries as $country)
                              <option value="{{ $country->id }}" {{ (in_array($country->id, $booking->getCountryDestinations()->pluck('country_id')->toArray()) ) ? 'selected' : '' }}>{{ $country->name }} - {{ $country->code}}</option>
                            @endforeach
                          </select>
                          <span class="text-danger" role="alert"></span>
                        </div>
                                ...
                                <div class="row"> 
                                  ...
                                  <div class="col-md-3 booking-whole-markup-feilds {{ $booking->markup_type == 'whole' ? 'd-none' : '' }}">
                                    <div class="form-group">
                                      ...
                                      <div class="input-group">
                                        <input type="text" step="any" value="{{ \Helper::number_format($booking_detail->markup_percentage) }}" name="quote[{{ $key }}][markup_percentage]" data-name="markup_percentage" id="quote_{{ $key }}_markup_percentage" class="form-control markup-percentage change remove-zero-values" value="0.00" readonly>
                                        <div class="input-group-append">
