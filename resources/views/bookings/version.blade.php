              ...
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col-sm-6">
                    ...
                    <div class="form-group">
                      <input type="text" name="booking_details" id="booking_details" class="form-control" value="{{ isset($booking['booking_details']) & !empty($booking['booking_details']) ? $booking['booking_details'] : '' }}" placeholder="Enter Booking Details">
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-3">
                          <div class="form-group">
                            ...
                            <input type="text" value="{{ $booking['lead_passenger_medical_requirement'] }}" name="lead_passenger_medical_requirement" id="lead_passenger_medical_requirement" class="form-control" placeholder="Medical Requirements" >
                            <span class="text-danger" role="alert"></span>
                          </div>
                        </div>
                      ...
                      <div class="quote card card-default quote-{{$key}}" data-key="{{$key}}">
                        ...
                        <div class="card-body">
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-2">
                              <div class="form-group">
                                ...
                                <div class="input-group">
                                  ...
                                  <input type="text" value="{{ $booking_detail['end_date_of_service']}}" name="quote[{{ $key }}][end_date_of_service]" data-name="end_date_of_service" id="quote_{{ $key }}_end_date_of_service" class="form-control end-date-of-service bookingEndDateOfService datepicker"  placeholder="DD/MM/YYYY" autocomplete="off">
                                </div>
                            ...
                            <div class="col-sm-2 show-tf {{ isset($log->getQueryData($booking_detail['category_id'], 'Category')->first()->show_tf) && ($log->getQueryData($booking_detail['category_id'], 'Category')->first()->show_tf == 0) ? 'd-none' : '' }}">
                              <div class="form-group">
                            ...
                            <div class="col-sm-2 {{ isset($log->getQueryData($booking_detail['category_id'], 'Category')->first()->second_tf) && ($log->getQueryData($booking_detail['category_id'], 'Category')->first()->second_tf == 0) ? 'd-none' : '' }} second-tf">
                              <div class="form-group">
                                ...
                                <select name="quote[{{ $key }}][supplier_country_ids][]" class="form-control select2-multiple supplier-country-id" data-placeholder="Select Supplier Country" multiple>
                                  @foreach ($countries as $country)
                                    <option value="{{ $country->id }}" 
                                      {{ in_array($country->id, json_decode($booking_detail['supplier_country_ids'])) ? 'selected' : NULL}} 
