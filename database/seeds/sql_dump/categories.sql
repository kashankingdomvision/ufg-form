...
UPDATE `categories` SET `feilds` = '[{\"type\":\"text\",\"label\":\"Route\",\"className\":\"form-control\",\"name\":\"text-1649329156994-0\",\"subtype\":\"text\"},{\"type\":\"autocomplete\",\"label\":\"Cabin Type\",\"className\":\"form-control\",\"name\":\"autocomplete-1646486244787-0\",\"requireValidOption\":false,\"data\":\"cabin_types\",\"values\":[{\"label\":\"Option 1\",\"value\":\"option-1\",\"selected\":true},{\"label\":\"Option 2\",\"value\":\"option-2\",\"selected\":false},{\"label\":\"Option 3\",\"value\":\"option-3\",\"selected\":false}]}]' WHERE `categories`.`id` = 4;
