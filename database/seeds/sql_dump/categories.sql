...
--  Cruise
UPDATE `categories` SET `feilds` = '[{\"type\":\"autocomplete\",\"label\":\"Group Owner\",\"className\":\"form-control\",\"name\":\"autocomplete-1643891903978-0\",\"requireValidOption\":false,\"data\":\"group_owners\",\"values\":[{\"label\":\"Option 1\",\"value\":\"option-1\",\"selected\":true},{\"label\":\"Option 2\",\"value\":\"option-2\",\"selected\":false},{\"label\":\"Option 3\",\"value\":\"option-3\",\"selected\":false}]},{\"type\":\"autocomplete\",\"label\":\"Cabin Type\",\"className\":\"form-control\",\"name\":\"autocomplete-1646486244787-0\",\"requireValidOption\":false,\"data\":\"cabin_types\",\"values\":[]}]' WHERE `categories`.`id` = 4;
