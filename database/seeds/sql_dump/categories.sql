...
UPDATE `categories` SET `feilds` = '[{\"type\":\"autocomplete\",\"label\":\"Departure Airport\",\"className\":\"form-control\",\"name\":\"autocomplete-1643888679811-0\",\"requireValidOption\":false,\"data\":\"airport_codes\",\"values\":[]},{\"type\":\"autocomplete\",\"label\":\"Arrival Airport\",\"className\":\"form-control\",\"name\":\"autocomplete-1643888683844-0\",\"requireValidOption\":false,\"data\":\"airport_codes\",\"values\":[]}]' WHERE `categories`.`id` = 4;

UPDATE `categories` SET `show_tf` = '1' WHERE `categories`.`id` = 4;
UPDATE `categories` SET `label_of_time` = 'Departure Time' WHERE `categories`.`id` = 4;

UPDATE `categories` SET `second_tf` = '1' WHERE `categories`.`id` = 4;
UPDATE `categories` SET `second_label_of_time` = 'Arrival Time' WHERE `categories`.`id` = 4;
