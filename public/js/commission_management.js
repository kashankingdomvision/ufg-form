...
$(document).ready(function () {
  ...
  $(document).on("change", '.pay-commission-amount', function (e) {
    ...
    if (salePersonPayments !== undefined) {
      ...
      var currentOutstandingAmount = removeComma($('.current-outstanding-amount').val());
      var calBalanceOwedOutstandingAmount = parseFloat(currentOutstandingAmount) - parseFloat(getTotalPayCommissionAmount());
